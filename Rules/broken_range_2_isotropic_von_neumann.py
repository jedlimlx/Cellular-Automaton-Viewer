...
hensel = {0: {"a": [0, 0, 0, 0, 0, 0, 0, 0]},
          ...
          2: {"c": [1, 0, 1, 0, 0, 0, 0, 0], "e": [0, 1, 0, 0, 0, 0, 1, 0],
              "k": [0, 1, 0, 0, 1, 0, 0, 0], "a": [1, 1, 0, 0, 0, 0, 0, 0],
              "i": [0, 1, 0, 0, 0, 1, 0, 0], "n": [1, 0, 0, 0, 1, 0, 0, 0]},
          3: {"c": [1, 0, 1, 0, 1, 0, 0, 0], "e": [0, 1, 0, 1, 0, 1, 0, 0],
...
def rotate_4(neighbours):
    rotate_1 = rotate(neighbours)
    rotate_2 = rotate(rotate_1)
    rotate_3 = rotate(rotate_2)
    return [tuple(neighbours), tuple(rotate_1), tuple(rotate_2), tuple(rotate_3)]
...
current_trans = ""
survival_trans = []
survival_string = rule_string.split("/")[1]
