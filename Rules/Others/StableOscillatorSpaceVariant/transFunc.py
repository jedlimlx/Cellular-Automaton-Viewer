...
rule_name = "StableOscillatorSpaceVariant"  # Rule Name
...
def transition_func(neighbours, generation):
    ...
    if 2 <= n <= 3 or 10 <= n <= 12 or 15 <= n <= 18: return neighbours[8]
    if (n == 4 or n == 13) and neighbours[8] < 4: return neighbours[8] + 1
