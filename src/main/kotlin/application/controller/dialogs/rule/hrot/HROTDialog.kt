...
class HROTDialog : RuleWidget() {
    ...
    override fun updateRule(rulestring: String?) {
        ...
        if (neighbourhoodAndWeights.value0 != null) {
            (ruleFamily as HROT).neighbourhood = neighbourhoodAndWeights.value0
            if (neighbourhoodAndWeights.value1 != null) {
                (ruleFamily as HROT).weights = neighbourhoodAndWeights.value1
            }
        }
    }
}