...
class HROTBSFKLDialog : RuleWidget() {
    ...
    override fun updateRule(rulestring: String?) {
        ...
        if (neighbourhoodAndWeights.value0 != null) {
            (ruleFamily as HROTBSFKL).neighbourhood = neighbourhoodAndWeights.value0
            if (neighbourhoodAndWeights.value1 != null) {
                (ruleFamily as HROTBSFKL).weights = neighbourhoodAndWeights.value1
            }
        }
    }
}