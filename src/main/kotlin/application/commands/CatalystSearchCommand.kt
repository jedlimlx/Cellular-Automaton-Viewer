...
class CatalystSearchCommand : Runnable {
    ...
    private val rotateCatalysts = false
    ...
    private val flipCatalysts = false
    ...
    private val catalysts: File? = null
    ...
    private val searchArea: File? = null
