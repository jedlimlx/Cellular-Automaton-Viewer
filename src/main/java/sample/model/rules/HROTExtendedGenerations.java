...
public class HROTExtendedGenerations extends RuleFamily {
    /**
    ...
    /**
     * The neighbourhood of the HROT Extended Generations rule
     */
    private Coordinate[] neighbourhood;

    /**
     * The neighbourhood weights of the HROT Extended Generations rule.
