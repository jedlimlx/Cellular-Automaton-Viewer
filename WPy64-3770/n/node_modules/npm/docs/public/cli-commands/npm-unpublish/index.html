...
<p>With the default registry (<code class="language-text">registry.npmjs.org</code>), unpublish is
only allowed with versions published in the last 72 hours. If you
are trying to unpublish a version published longer ago than that,
contact support@npmjs.com.</p>
<p>The scope is optional and follows the usual rules for <a href="../../using-npm/scope"><code class="language-text">scope</code></a>.</p>
