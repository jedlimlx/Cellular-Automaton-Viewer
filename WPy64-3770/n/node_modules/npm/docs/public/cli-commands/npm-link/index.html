...
link</code> command was executed. (see <a href="npm-config"><code class="language-text">npm-config</code></a> for the value of <code class="language-text">prefix</code>). It
will also link any bins in the package to <code class="language-text">{prefix}/bin/{name}</code>.</p>
